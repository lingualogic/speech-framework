/**
 * Gulp-Datei zur Erzeugung der Cordova-Version der IntentApp unter Mac OS X
 */
...
module.exports = ({ gulp, exec, srcDir, globalDistDir, globalCredentialsDir, appDir, cordovaDir, cordovaAppDir, cordovaWwwDir }) => {
    ...
    gulp.task('cordova-run-ios', (done) => {
        exec(`cd ${cordovaAppDir} && cordova run ios --buildFlag='-UseModernBuildSystem=0' --debug`, done);
    });
