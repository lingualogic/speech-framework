...
* 0.5.13.0056 Alpha vom 23.07.2019 [Release Notizen](./CHANGELOG.md)
...
Das im dist Ordner erzeugte npm-Paket 'speech-framework-0.5.13.tgz' kann in den eigenen Web-Projektordner kopiert werden.
